        ...
        <main className="container mx-auto px-4">
          ...
          <section id="factions" className="py-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                { name: 'Люди', color: 'blue', icon: '🛡️', description: 'Благородные рыцари и искусные стратеги' },
                { name: 'Эльфы', color: 'green', icon: '🏹', description: 'Мастера лука и магии природы' },
                { name: 'Зараженные', color: 'purple', icon: '👹', description: 'Ужасающие создания, несущие хаос' },
                { name: 'Нежить', color: 'gray', icon: '💀', description: 'Бессмертные воины темной магии' }
              ].map((faction) => (
          ...
          <section id="newsletter" className="py-20">
            ...
            <div className="bg-gray-800 bg-opacity-50 p-8 rounded-lg max-w-2xl mx-auto">
              ...
              <form className="flex gap-4">
                <Input type="email" placeholder="Ваш email" className="flex-grow bg-gray-700 text-white" />
